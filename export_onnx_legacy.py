...
def export_onnx_legacy(model_path='bottle_overfit_model.pth', output_path='bottle_model_legacy.onnx'):
    ...
    # Using opset 11 for maximum compatibility with older ONNX tools
