...
def export_onnx(model_path='bottle_overfit_model_epoch_200.pth', output_path='bottle_model_full.onnx'):
    ...
    # Add do_constant_folding=True and keep_initializers_as_inputs=False to ensure weights are included
