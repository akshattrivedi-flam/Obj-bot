...
def export_onnx_traced(model_path='bottle_overfit_model.pth', output_path='bottle_model_traced.onnx'):
    ...
    torch.onnx.export(traced_model, sample_input, output_path, 
